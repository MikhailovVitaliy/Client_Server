...
namespace CSA_2S
{
    class Program
    {
        ...
        static public void bot(int gameMode, int hod)
        {
            if (gameMode == 1 && hod == 0)
            {
                while (true)
                {
                    ...
                    if (map[rnd.Next(8), rnd.Next(8)] % 2 == hod)
                    {
                        //тут должен быть бот
                        break;
                    }
        ...
        static public void messageUncoder(string mess)
        {
        ...
        static public void killer(int hod)
        {
            if (hod == 0)
            { bCount--; }
            else
        ...
        static public void damkee(int n1, int m1, int n2, int m2)      //атака и перемещение дамок
        {
            ...
            {
                if (map[n1, m1] != 0 && Math.Abs(m2 - m1) == Math.Abs(n2 - n1) && map[n2, m2] == 0)   //проверка шо выбрана не пустая клетка 
        ...
        static private void attack(int n1, int m1, int n2, int m2)     //атака пешек
        {
            ...
            {
                if (map[n1, m1] != 0 && Math.Abs(m2 - m1) == 2 && Math.Abs(n2 - n1) == 2 && map[n2, m2] == 0)   //проверка шо выбрана не пустая клетка 
        ...
        static private void move(int n1, int m1, int n2, int m2)       //движение пешек
        {
            if (map[n1, m1] == 1 || map[n1, m1] == 2)                       //для пешек
            {
                if (map[n1, m1] != 0 && Math.Abs(m2 - m1) == 1 && map[n2, m2] == 0)            //проверка шо выбрана не пустая клетка && что ход по диагонали по m
                {
                    if (map[n1, m1] % 2 == hod)                               //проверка на допустимость хода 
                    {
